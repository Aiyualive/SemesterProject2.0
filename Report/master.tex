...
\todo{show a few defects and their signals} \todo{appendix for more signals?}
...
%Find all peaks with scipy.signal.find_peaks (https://docs.scipy.org/doc/scipy/reference/generated/scipy.signal.find_peaks.html)
%According to defect timestamp at a given axle, search around for the highest peak within a 2 sec window (tunable parameter)
%Center the window at the highest peak with a window size of 1 sec (tunable)
