...
\documentclass[ % the name of the author
                ...
                supervisor={Supervised by: Prof. Eleni Chatzi, Cyprien Hoelzl},
                % the degree programme
                    degree={BSc},
                % the dissertation    title (which cannot be blank)
                     title={Semester Project Intermediate Report},
                % the dissertation subtitle (which can    be blank)
                  subtitle={Data-driven identificiation and classification of rail surface defects},
